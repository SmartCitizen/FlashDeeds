...
<!DOCTYPE html>
	...
	<div id="pricingWrap">
		<div class="container">
			<div class="row">
				<div class="col-xs-12">
					<h2 class="sectionTitle">New Account Error!</h2>
				  <p>We are sorry but we encountered some kinda of  error in trying to create<br />
a new account.  There could be an internet outage or database error. <br />
<br />
Please report this problem via email to:</p>
                  <p><a href="mailto:darren.kearl@ahasf.org">darren.kearl@ahasf.org</a></p>
                  <p>Thank you.</p>
                  <p>Q Foundation<br />
                    (415) 552-3242 x 108</p>
<p></p>
<p>&nbsp;</p>
					<p>&nbsp;</p>
				</div>
